...
Put this into the terminal to build:


```bash
autoreconf -i

./configure --prefix=/usr --sysconfdir=/etc --disable-static --disable-examples-build --disable-x11-examples-build --enable-udev-rules --disable-debug-log
